...
namespace UserManagement.Api.Tests.IntegrationTests.TestHelpers;
...
public class TestDbFactory : WebApplicationFactory<Program>
{
    ...
    protected override IHost CreateHost(IHostBuilder builder)
    {
        builder.ConfigureAppConfiguration(configBuilder =>
        {
            ...
            {
                { AuthConstants.ApiKeySectionName, "test-api-key" }
            };
        ...
        {
            services.AddSingleton(_userManagementDbContext);
        });
    ...
    private void Seed()
    {
        _userManagementDbContext.Database.EnsureDeleted();
        _userManagementDbContext.Database.EnsureCreated();
        if (!_userManagementDbContext.Users!.Any())
        {
            _userManagementDbContext.Users!.AddRange(
                new User
                {
                    Id = 1,
                    Forename = "Peter",
            ...
            _userManagementDbContext.Logs!.AddRange(
        ...
        _userManagementDbContext.SaveChangesAsync();
    }
}
